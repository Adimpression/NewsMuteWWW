...
!function () {
    ...
    function b(e) {
        clearTimeout(ie), (!ionic.keyboard.isOpen || ionic.keyboard.isClosing) && (ionic.keyboard.isOpening = !0, ionic.keyboard.isClosing = !1), ionic.keyboard.height = e.keyboardHeight, ae ? M(P, !0) : M(C, !0)
    }

    function w(e) {
        clearTimeout(ie), e.target && !e.target.readOnly && ionic.tap.isKeyboardElement(e.target) && (te = V(e.target)) && (ee = e.target, document.body.scrollTop = 0, te.scrollTop = 0, ionic.requestAnimationFrame(function () {
            document.body.scrollTop = 0, te.scrollTop = 0
        }), (!ionic.keyboard.isOpen || ionic.keyboard.isClosing) && (ionic.keyboard.isOpening = !0, ionic.keyboard.isClosing = !1), document.addEventListener("keydown", L, !1), window.navigator.msPointerEnabled ? document.addEventListener("MSPointerMove", x, !1) : document.addEventListener("touchmove", x, !1), ionic.keyboard.isOpen || R() ? ionic.keyboard.isOpen && C() : M(C, !0))
    }
    ...
    function D() {
        ionic.keyboard.isLandscape = !ionic.keyboard.isLandscape, ionic.Platform.isIOS() && P(), ionic.Platform.isAndroid() && (ionic.keyboard.isOpen && R() ? ae = !0 : M(P, !1))
    }
    ...
    function M(e, t) {
        ...
        return n = ionic.Platform.isAndroid() && ionic.Platform.version() < 4.4 ? 30 : ionic.Platform.isAndroid() ? 10 : 1, ne = setInterval(function () {
            r = k(), (!(++i < n) || (O(r) || A(r)) && ionic.keyboard.height) && (R() || (ionic.keyboard.height = Math.abs(o - window.innerHeight)), ionic.keyboard.isOpen = t, clearInterval(ne), e())
        }, 50), n
    }
    ...
    function N() {
        ...
        }), window.navigator.msPointerEnabled ? document.removeEventListener("MSPointerMove", x) : document.removeEventListener("touchmove", x), document.removeEventListener("keydown", L), ionic.Platform.isAndroid() && (R() && cordova.plugins.Keyboard.close(), ee && ee.blur())
    }
    ...
    function P() {
        ae = !1, oe = k(), ionic.keyboard.isLandscape && !se ? se = oe : ionic.keyboard.isLandscape || re || (re = oe), ionic.trigger("resetScrollView", {target: ee}, !0), ionic.keyboard.isOpen && ionic.tap.isTextInput(ee) && C()
    }
    ...
    function k() {
        var e = window.innerHeight;
        return ionic.Platform.isAndroid() && ionic.Platform.isFullScreen || !ionic.keyboard.isOpen && !ionic.keyboard.isOpening || ionic.keyboard.isClosing ? e : e + I()
    }
    ...
    function z() {
        ...
        if (ue) {
            var t, n = ue.content.toLowerCase().replace(/\s+/g, "").split(",");
    ...
    function H() {
        var e = de.width, t = de.height, n = ionic.Platform, i = n.version(), o = "device-width", r = "device-height", s = ionic.viewport.orientation();
        delete de.height, de.width = o, n.isIPad() ? i > 7 ? delete de.width : n.isWebView() ? 90 == s ? de.height = "0" : 7 == i && (de.height = r) : 7 > i && (de.height = "0") : n.isIOS() && (n.isWebView() ? i > 7 ? delete de.width : 7 > i ? t && (de.height = "0") : 7 == i && (de.height = r) : 7 > i && t && (de.height = "0")), (e !== de.width || t !== de.height) && F()
    }
    ...
    window.ionic = window.ionic || {}, window.ionic.views = {}, window.ionic.version = "1.0.0-rc.4", function (e) {
    ...
    var ee, te, ne, ie, oe = 0, re = 0, se = 0, ae = !1, le = "keyboard-open", ce = "scroll-content";
    ionic.keyboard = {
        isOpen: !1,
        isClosing: !1,
        isOpening: !1,
    ...
    !function (e) {
        ...
        _e.effect.Animate = {
            requestAnimationFrame: function () {
                ...
                var v = function (r) {
                    ...
                    l && (h = (g - d) / l, h > 1 && (h = 1));
                    var S = c ? c(h) : h;
                    e(S, g, m) !== !1 && 1 !== h || !m ? m && (_ = g, _e.effect.Animate.requestAnimationFrame(v, u)) : (o[p] = null, a && a(n - f / ((g - d) / i), p, 1 === h || null == l))
                };
                return o[p] = !0, _e.effect.Animate.requestAnimationFrame(v, u), p
            }
        }
    }(this), function (e) {
        var t = function () {
        ...
        e.views.Scroll = e.views.View.inherit({
            ...
            zoomTo: function (e, t, n, i) {
                ...
                o.__isDecelerating && (_e.effect.Animate.stop(o.__isDecelerating), o.__isDecelerating = !1);
                var r = o.__zoomLevel;
            ...
            scrollTo: function (e, t, n, i, o) {
                var r = this;
                if (r.__isDecelerating && (_e.effect.Animate.stop(r.__isDecelerating), r.__isDecelerating = !1), null != i && i !== r.__zoomLevel) {
            ...
            doTouchStart: function (e, t) {
                var n = this;
                n.__decStopped = !(!n.__isDecelerating && !n.__isAnimating), n.hintResize(), t instanceof Date && (t = t.valueOf()), "number" != typeof t && (t = Date.now()), n.__interruptedAnimation = !0, n.__isDecelerating && (_e.effect.Animate.stop(n.__isDecelerating), n.__isDecelerating = !1, n.__interruptedAnimation = !0), n.__isAnimating && (_e.effect.Animate.stop(n.__isAnimating), n.__isAnimating = !1, n.__interruptedAnimation = !0);
            ...
            __publish: function (e, t, o, r, s) {
                ...
                if (l && (_e.effect.Animate.stop(l), a.__isAnimating = !1), r && a.options.animating) {
                    ...
                    a.__isAnimating = _e.effect.Animate.start(p, m, g, a.options.animationDuration, l ? n : i)
            ...
            __startDeceleration: function () {
                ...
                e.__isDecelerating = _e.effect.Animate.start(r, s, a)
            },
...
!function () {
    function e(e, t, n, i, o, r) {
        function a(i, a, c, s, l) {
            ...
            var T, B = C[1], I = C[2], x = t(I), A = {}, E = {}, V = {}, P = [], D = c.itemRenderBuffer || c.collectionBufferSize, _ = angular.isDefined(D) ? parseInt(D) : S, L = c.itemHeight || c.collectionItemHeight, R = c.itemWidth || c.collectionItemWidth, N = p(), M = f();
        ...
        return function (o) {
            ...
            function l() {
                this.getItemPrimarySize = P, this.getItemSecondarySize = _, this.getScrollValue = function () {
                    return Math.max(0, Math.min(I.__scrollTop - U, I.__maxScrollTop - U - q))
            ...
            function u() {
                this.getItemPrimarySize = _, this.getItemSecondarySize = P, this.getScrollValue = function () {
                    return Math.max(0, Math.min(I.__scrollLeft - U, I.__maxScrollLeft - U - q))
                }, this.refreshDirection = function () {
            ...
            function h() {
                this.getContentSize = function () {
                    return this.getEstimatedPrimaryPos(A.length - 1) + this.estimatedPrimarySize + U + q
                };
                var e = {};
            ...
            function p() {
                ...
                this.getContentSize = function () {
                    var e = c[n] || i;
                    return (e.primaryPos + e.primarySize || 0) + this.getEstimatedPrimaryPos(A.length - n - 1) + U + q
            ...
            this.refreshLayout = function () {
                ...
                q = (parseInt(e[L ? "height" : "width"]) || 0) + (n && parseInt(n[L ? "marginTop" : "marginLeft"]) || 0) + (i && parseInt(i[L ? "marginBottom" : "marginRight"]) || 0), U = 0;
                var o = $;
                do U += o[L ? "offsetTop" : "offsetLeft"]; while (ionic.DomUtil.contains(I.__content, o = o.offsetParent));
                var a = $.previousElementSibling, c = a ? t.getComputedStyle(a) : {}, l = parseInt(c[L ? "marginBottom" : "marginRight"] || 0);
                if ($.style[ionic.CSS.TRANSFORM] = H.replace(M, -l).replace(z, 0), U -= l, I.__clientHeight && I.__clientWidth || (I.__clientWidth = I.__container.clientWidth, I.__clientHeight = I.__container.clientHeight), (ee.onRefreshLayout || angular.noop)(), ee.refreshDirection(), Q(), !ie)for (var u = Math.max(20, 3 * T), d = 0; u > d; d++)G.push(new s);
    ...
    c.factory("$ionicActionSheet", ["$rootScope", "$compile", "$animate", "$timeout", "$ionicTemplateLoader", "$ionicPlatform", "$ionicBody", "IONIC_BACK_PRIORITY", function (e, t, n, i, o, r, a, c) {
        ...
        function d(e) {
            return e ? _.histories[e] : null
        }

        function f(e) {
            var t = h(e);
            return _.histories[t.historyId] || (_.histories[t.historyId] = {
        ...
        function p(e) {
            _.currentView = c(e), _.backView = l(_.currentView), _.forwardView = u(_.currentView)
        }
        ...
        var w, b, y, S, k = "initialView", C = "newView", T = "moveBack", B = "moveForward", I = "back", x = "forward", A = "enter", E = "exit", V = "swap", P = "none", D = 0, _ = {
            histories: {
                root: {
                    historyId: "root",
        ...
        return L.prototype.initialize = function (e) {
            ...
            if (this.url && this.url !== n.url()) {
                if (_.backView === this)return i.history.go(-1);
                if (_.forwardView === this)return i.history.go(1);
                n.url(this.url)
            }
            return null
            ...
            register: function (e, t) {
                var i, a, s, u = v(), m = f(e), L = _.currentView, R = _.backView, N = _.forwardView, M = null, z = null, H = P, O = m.historyId, U = n.url();
                if (w !== u && (w = u, D++), S)M = S.viewId, z = S.action, H = S.direction, S = null; else if (R && R.stateId === u)M = R.viewId, O = R.historyId, z = T, R.historyId === L.historyId ? H = I : L && (H = E, i = d(R.historyId), i && i.parentHistoryId === L.historyId ? H = A : (i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId && (H = V))); else if (N && N.stateId === u)M = N.viewId, O = N.historyId, z = B, N.historyId === L.historyId ? H = x : L && (H = E, L.historyId === m.parentHistoryId ? H = A : (i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId && (H = V))), i = h(e), N.historyId && i.scope && (i.scope.$historyId = N.historyId, O = N.historyId); else if (L && L.historyId !== O && m.cursor > -1 && m.stack.length > 0 && m.cursor < m.stack.length && m.stack[m.cursor].stateId === u) {
                    var q = m.stack[m.cursor];
                    M = q.viewId, O = q.historyId, z = T, H = V, i = d(L.historyId), i && i.parentHistoryId === O ? H = E : (i = d(O), i && i.parentHistoryId === L.historyId && (H = A)), i = c(q.backViewId), i && q.historyId !== i.historyId && (m.stack[m.cursor].backViewId = L.viewId)
                } else {
                    ...
                    if (M = ionic.Utils.nextUid(), L) {
                        if (L.forwardViewId = M, z = C, N && L.stateId !== N.stateId && L.historyId === N.historyId && (i = d(N.historyId))) {
                        ...
                        m.historyId === L.historyId ? H = x : L.historyId !== m.historyId && (H = A, i = d(L.historyId), i && i.parentHistoryId === m.parentHistoryId ? H = V : (i = d(i.parentHistoryId), i && i.historyId === m.historyId && (H = E)))
                    } else z = k;
                    2 > D && (H = P), _.views[M] = this.createView({
                        viewId: M,
                        ...
                        url: U,
                        canSwipeBack: $(s, t)
                    }), m.stack.push(_.views[M])
                }
                if (o.cancel(y), b) {
                    if (b.disableAnimate && (H = P), b.disableBack && (_.views[M].backViewId = null), b.historyRoot) {
                        for (a = 0; a < m.stack.length; a++)m.stack[a].viewId === M ? (m.stack[a].index = 0, m.stack[a].backViewId = m.stack[a].forwardViewId = null) : delete _.views[m.stack[a].viewId];
                        m.stack = [_.views[M]]
                    }
                    b = null
                }
                if (p(M), _.backView && O == _.backView.historyId && u == _.backView.stateId && U == _.backView.url)for (a = 0; a < m.stack.length; a++)if (m.stack[a].viewId == M) {
                    z = "dupNav", H = P, a > 0 && (m.stack[a - 1].forwardViewId = null), _.forwardView = null, _.currentView.index = _.backView.index, _.currentView.backViewId = _.backView.backViewId, _.backView = l(_.backView), m.stack.splice(a, 1);
                    break
                }
                return m.cursor = _.currentView.index, {
                    viewId: M,
                    action: z,
                    direction: H,
                    historyId: O,
                    enableBack: this.enabledBack(_.currentView),
                    isHistoryRoot: 0 === _.currentView.index,
                    ele: s
                }
                ...
                return arguments.length && (_.currentView = e), _.currentView
            }, currentHistoryId: function () {
                return _.currentView ? _.currentView.historyId : null
            }, currentTitle: function (e) {
                return _.currentView ? (arguments.length && (_.currentView.title = e), _.currentView.title) : void 0
            }, backView: function (e) {
                return arguments.length && (_.backView = e), _.backView
            }, backTitle: function (e) {
                var t = e && c(e.backViewId) || _.backView;
                return t && t.title
            }, forwardView: function (e) {
                return arguments.length && (_.forwardView = e), _.forwardView
                ...
                if (e) {
                    var t = d(e);
                    if (t && t.stack.length) {
                        if (_.currentView && _.currentView.viewId === t.stack[0].viewId)return;
                        S = {viewId: t.stack[0].viewId, action: T, direction: I}, t.stack[0].go()
                    }
                }
            }, goBack: function () {
                _.backView && _.backView.go()
            }, enabledBack: function (e) {
                var t = l(e);
                return !(!t || t.historyId !== e.historyId)
            }, clearHistory: function () {
                var e = _.histories, t = _.currentView;
                ...
                for (var i in _.views)i !== t.viewId && delete _.views[i];
                t && p(t.viewId)
            }, clearCache: function () {
                o(function () {
                ...
                return arguments.length && (o.cancel(y), null === e ? b = e : (b = b || {}, s(b, e), b.expire && (y = o(function () {
                    b = null
                }, b.expire)))), b
    ...
    c.factory("$ionicPopup", ["$ionicTemplateLoader", "$ionicBackdrop", "$q", "$timeout", "$rootScope", "$ionicBody", "$compile", "$ionicPlatform", "IONIC_BACK_PRIORITY", function (e, t, n, i, o, r, a, c, l) {
            ...
            create: function (t, l, h, T, E, L) {
                var R, N, M, z = ++A, H = {
                    init: function (e, t) {
                        ...
                        for (n = 0, i = r.length; i > n && (o = r.eq(n), o.data(y) === c ? o.data(w) ? (o.data(y, c + ionic.Utils.nextUid()), o.data(b, !0)) : R = o : u(s) && o.data(y) === s && (N = o), !R || !N); n++);
                        M = !!R, M || (R = e.ele || _.createViewEle(l), R.data(y, c)), L && t.activeEleId(c), e.ele = null
                    }, render: function (e, n) {
                        if (M)ionic.Utils.reconnectScope(R.scope()); else {
                            p(R, x);
                            var i = d(l, R, e.direction, h), r = o.transitions.views[i.transition] || o.transitions.views.none;
                            r(R, null, i.direction, !0).run(0), R.data(C, {
                                viewId: i.viewId,
                                historyId: i.historyId,
                                stateName: i.stateName,
                                stateParams: i.stateParams
                            }), (c(l).cache === !1 || "false" === c(l).cache || "false" == R.attr("cache-view") || 0 === o.views.maxCache()) && R.data(w, !0);
                            var a = t.appendViewElement(R, l);
                            delete i.direction, delete i.transition, a.$emit("$ionicView.loaded", i)
                        }
                        R.data(S, Date.now()), n && n()
                    }, transition: function (a, c, u) {
                        function v() {
                            p(R, F.shouldAnimate ? "entering" : B), p(N, F.shouldAnimate ? "leaving" : I), F.run(1), r._instances.forEach(function (e) {
                        ...
                        function b() {
                            b.x || (b.x = !0, R.off($, w), e.cancel(R.data(k)), N && e.cancel(N.data(k)), H.emit("after", O, U), C && C.resolve(t), z === A && (n.all(P).then(_.transitionEnd), H.cleanup(O)), r._instances.forEach(function (e) {
                        ...
                        function S() {
                            p(R, I), p(N, B), R.off($, y), e.cancel(R.data(k)), _.transitionEnd([t])
                        }

                        var C, O = d(l, R, a, h), U = s(s({}, O), f(T));
                        O.transitionId = U.transitionId = z, O.fromCache = !!M, O.enableBack = !!c, O.renderStart = E, O.renderEnd = L, V(R.parent(), "nav-view-transition", O.transition), V(R.parent(), "nav-view-direction", O.direction), e.cancel(R.data(k));
                        var q = o.transitions.views[O.transition] || o.transitions.views.none, F = q(R, N, O.direction, O.shouldAnimate && u && L);
                        if (F.shouldAnimate && (R.on($, w), R.data(k, e(b, D)), i.show(D)), E && (H.emit("before", O, U), p(R, x), F.run(0)), L && (C = n.defer(), P.push(C.promise)), E && L)e(v, 16); else {
                            if (!L)return p(R, "entering"), p(N, "leaving"), {
                                run: F.run,
                                cancel: function (t) {
        ...
        function r() {
            ionic.requestAnimationFrame(function () {
                ...
                s.jsScrolling && s.scrollView.resize(), s.scrollView.__container && s.scrollView.__container.offsetHeight > 0 && s.checkBounds()
            }, 30, !1), s.isLoading = !1
        }
        ...
        I.scope = e, I.element = t, I.init = function () {
            ...
            for (var e, n, i = t.children(), o = 0, r = i.length; r > o; o++)e = i.eq(o), A(e) == B ? l.destroyViewEle(e) : A(e) == T && (n = e.scope(), n && n.$broadcast("$ionicView.clearCache"))
        ...
        l = s.scrollView = s.isNative() ? new ionic.views.ScrollNative(t) : new ionic.views.Scroll(t), (f.parent().length ? f.parent() : f).data("$$ionicScrollController", s);
        ...
        c.controller("$ionicSpinner", ["$element", "$attrs", function (n, i) {
            ...
            this.init = function () {
                ...
                return t("svg", {
                    viewBox: "0 0 64 64",
                    g: [v[o]]
                }, a, o), n.html(a.innerHTML), this.start(), o
            }, this.start = function () {
                g[o] && g[o](n[0])()
            }
        }])
            ...
            compile: function (e, o) {
                function r(e, r, s) {
                    ...
                    if (e.$watch(function () {
                        ...
                        }), e.$hasHeader = e.$hasSubheader = e.$hasFooter = e.$hasSubfooter = e.$hasTabs = e.$hasTabsTop = !1, n(e, s, {
                            $onScroll: "&onScroll",
                            ...
                            startY: "@",
                            scrollEventInterval: "@"
                        }), e.direction = e.direction || "y", u(s.padding) && e.$watch(s.padding, function (e) {
                            (a || r).toggleClass("padding", !!e)
                        }), "false" === s.scroll); else {
                        var f = {};
                        "true" !== o.overflowScroll && i.scrolling.jsScrolling() ? f = {
                            el: r[0],
                            ...
                            f && (f.scrollingComplete = p, delete f.el), a = null, r = null, o.$$element = null
                        })
                    }
                }

                var a, c;
                return e.addClass("scroll-content ionic-scroll"), "false" != o.scroll ? (a = h('<div class="scroll"></div>'), a.append(e.contents()), e.append(a)) : e.addClass("scroll-content-false"), {pre: r}
            }
        }
                ...
                return t.append(i), function (t, i, o, r) {
                    function a() {
                        ...
                        t.$on("$destroy", function () {
                            ...
                            if (e || t) {
                                e && c.closeOptionButtons(), c.canSwipeItems(!e), i.children().toggleClass("list-left-editing", e),
        ...
        return {
            restrict: "E", scope: !0, controller: function () {
                ...
                function i(e, i, r) {
                    ...
                    a && (c.speedMultiplier = .8, c.bouncing = !1), t("$ionicScroll", {
                        $scope: e,
                        scrollViewOptions: c
                    })
                }
